...
from string import digits, uppercase, ascii_letters
...
class OutsideWidget(QtGui.QWidget):
...
class PageRect(QtGui.QGraphicsRectItem):
...
class PrintDialog(QtGui.QDialog):
    ...
    def __init__(self, main, parent):
        ...
        self.page = PageRect(self, self.output, pagefont)
